...
public class DefaultCollectionDifferencerTest {
    ...
    @Test
    public final void testExpectedLarger() {
        final List<Delta> deltas = new LinkedList<>();
        ...
        Assert.assertEquals("NO_MATCHING_ELEMENT: java.util.List[3] (java.lang.Integer): no matching element for [3]", deltas.get(4).toString());
    }

    @Test
    public final void testActualLarger() {
        final List<Delta> deltas = new LinkedList<>();
