...
/**
 * Test {@link DefaultMetaDataFactory#fromField(IFieldFinder, Field, Object)}.
 */
public class DefaultMetaDataFactoryFromFieldTest extends AbstractMetadataTestBase {
    private final IFieldFinder ff = new DefaultFieldFinder();
    ...
    public final void testGeneric() {
        ...
        final AbstractMetaData output = objectUnderTest.fromField(ff, field, root);
